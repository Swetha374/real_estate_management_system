...
SECRET_KEY = "django-insecure-cp67fwj(hojfhd)m%kk%*#37myx2+cz#gfh6-j-&2r@7^mx$^v"
...
TEMPLATES = [
    {
       ...
       "DIRS": [os.path.join(BASE_DIR, "real_estate_management_system/templates")],     
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
AUTHENTICATION_BACKENDS = ['api.v1.admin.authentication.EmailBackend']
